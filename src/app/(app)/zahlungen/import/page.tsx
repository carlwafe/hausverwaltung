...
function toEditRow(
  ...
  const gewaehlterMietvertragId = r.ignorieren || !r.vorgeschlagenerMietvertragId
    ? r.vorgeschlagenerMietvertragId ?? ""
    : r.vorgeschlagenerMietvertragId;
  const duplikat = pruefeDuplikat(bestehendeZahlungen, gewaehlterMietvertragId, r.datum, r.betrag);
  const ausgewaehlt =
...
export default function ZahlungenImportPage() {
  ...
  function istBereitsImportiert(r: EditRow): boolean {
    return pruefeDuplikat(bestehendeZahlungen, r.gewaehlterMietvertragId, r.datum, r.betrag);
  }
